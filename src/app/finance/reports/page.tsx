        ...
        <div className="space-y-6">
            ...
            <div className="hidden print:block border-b-2 border-slate-900 pb-4 mb-8">
                <div className="flex justify-between items-end">
                    <div>
                        <h1 className="text-4xl font-black tracking-tighter uppercase">{locale === 'ar' ? 'تقرير مالي' : 'Financial Report'}</h1>
                        <p className="text-slate-500 font-bold">ORBIT ERP ENTERPRISE</p>
                    </div>
                    <div className="text-right">
                        <p className="text-sm font-bold">{format(new Date(), 'dd MMMM yyyy')}</p>
                        <p className="text-xs text-slate-400">Generated by Orbit User</p>
                    </div>
                </div>
            </div>
